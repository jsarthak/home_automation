    ...
    private final View.OnTouchListener mDelayHideTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            if (bluetoothAdapter == null) {
                Toast.makeText(IntroActivity.this, "Bluetooth Device not available", Toast.LENGTH_SHORT).show();
            ...
            final SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(IntroActivity.this);
            AlertDialog.Builder builder = new AlertDialog.Builder(IntroActivity.this);
            builder.setTitle("Select Devie");
            ...
            final ArrayAdapter<String> list = new ArrayAdapter<String>(IntroActivity.this, android.R.layout.simple_selectable_list_item);
            ...
            builder.setAdapter(list, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    String device = list.getItem(which);
